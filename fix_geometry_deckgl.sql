-- Fix geometry_json para Deck.gl Polygon
-- Extrair apenas a parte "geometry" do Feature GeoJSON
...
SELECT 
    g.municipio_id,
    g.municipio_nome,
    -- EXTRAIR APENAS A PARTE GEOMETRY DO FEATURE
    (g.geometry_json->>'geometry')::text AS geometry_json,
...
SELECT 
    municipio_nome,
    LEFT(geometry_json, 100) AS geometry_preview,
    caso
